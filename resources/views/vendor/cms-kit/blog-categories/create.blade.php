...
<div class="card">
    ...
    <div class="card-body p-4">
        ...
        @endif
        <form action="{{ route('cms.blog-categories.store') }}" method="POST">
            @csrf
            ...
            <div class="tab-content mb-4 language-switcher-content">
                ...
                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}-content" role="tabpanel">
                    ...
                    <input type="text" name="translations[{{ $lang->code }}][title]" class="form-control @error("translations.{$lang->code}.title") is-invalid @enderror" value="{{ old("translations.{$lang->code}.title") }}" placeholder="e.g. Investment" required>
